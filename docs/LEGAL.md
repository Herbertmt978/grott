...
Upstream Grott currently does not include a license file that GitHub detects. On 2026-07-14, the fork owner confirmed that upstream redistribution permission has been obtained for this fork and its container images. Preserve the permission record outside this repository unless upstream publishes an explicit repository licence. Do not relicense inherited files in this fork without that permission.
